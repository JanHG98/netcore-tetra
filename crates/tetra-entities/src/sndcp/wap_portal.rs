...
pub const ALL_PAGES: [WapPage; 21] = [
    WapPage::Home,
    WapPage::Status,
    WapPage::Subscribers,
    WapPage::Groups,
...
impl WapPage {
    ...
    fn title(self) -> &'static str {
        match self {
            ...
            Self::Calls => "Rufe",
            Self::Sds => "SDS",
            Self::Tasks => "Auftraege",
            Self::TaskForms => "Formulare",
            Self::ControlRoom => "Control Room",
            Self::Health => "Health",
    ...
    fn previous(self) -> Option<Self> {
        match self {
            ...
            Self::Tasks => Some(Self::Sds),
            Self::TaskForms => Some(Self::Tasks),
            Self::ControlRoom => Some(Self::TaskForms),
    ...
    fn next(self) -> Option<Self> {
        match self {
            ...
            Self::Sds => Some(Self::Tasks),
            Self::Tasks => Some(Self::TaskForms),
            Self::TaskForms => Some(Self::ControlRoom),
...
fn page_line(page: WapPage, snapshot: &WapStatusSnapshot) -> String {
    ...
    match page {
        ...
        WapPage::Tasks => "Auftraege<br/>Task Workflow :8280".to_string(),
        WapPage::TaskForms => "Formulare<br/>XHTML/WML :8280".to_string(),
