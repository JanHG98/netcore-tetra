...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dtx continue in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DTxContinue`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DTxContinue`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
