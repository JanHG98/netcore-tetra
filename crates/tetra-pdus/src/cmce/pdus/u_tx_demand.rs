...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für utx demand in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `UTxDemand`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for UTxDemand`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
