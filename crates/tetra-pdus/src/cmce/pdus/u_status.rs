...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für ustatus in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `UStatus`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for UStatus`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
