...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für ucall Wiederherstellung in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `UCallRestore`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for UCallRestore`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
