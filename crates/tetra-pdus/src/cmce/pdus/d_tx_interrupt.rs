...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dtx interrupt in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DTxInterrupt`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DTxInterrupt`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
