...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für uconnect in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `UConnect`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for UConnect`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
