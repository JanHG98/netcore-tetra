...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dcall Wiederherstellung in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DCallRestore`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DCallRestore`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
