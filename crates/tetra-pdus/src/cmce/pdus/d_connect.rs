...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dconnect in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DConnect`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DConnect`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
...
mod tests {
    ...
    #[test]
    // Was: Prüft automatisch den Fall d connect.
