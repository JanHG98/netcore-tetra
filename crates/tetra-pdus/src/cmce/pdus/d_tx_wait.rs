...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dtx wait in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DTxWait`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DTxWait`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
