...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dalert in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DAlert`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DAlert`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
