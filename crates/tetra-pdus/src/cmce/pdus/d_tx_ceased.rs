...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dtx ceased in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DTxCeased`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DTxCeased`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
