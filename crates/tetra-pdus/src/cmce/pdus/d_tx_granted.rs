...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für dtx granted in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DTxGranted`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DTxGranted`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
