...
#[repr(u8)]
// Was: Listet die möglichen Varianten für short report type auf.
...
// Was: Implementiert das zugehörige Verhalten für `std::convert::TryFrom<u64> for ShortReportType`.
...
// Was: Implementiert das zugehörige Verhalten für `ShortReportType`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
...
// Was: Implementiert das zugehörige Verhalten für `From<ShortReportType> for u64`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
...
// Was: Implementiert das zugehörige Verhalten für `core::fmt::Display for ShortReportType`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
