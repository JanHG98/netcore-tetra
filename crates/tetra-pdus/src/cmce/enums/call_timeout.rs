...
#[repr(u8)]
// Was: Listet die möglichen Varianten für Ruf timeout auf.
...
// Was: Implementiert das zugehörige Verhalten für `std::convert::TryFrom<u64> for CallTimeout`.
...
// Was: Implementiert das zugehörige Verhalten für `CallTimeout`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
impl CallTimeout {
...
// Was: Implementiert das zugehörige Verhalten für `From<CallTimeout> for u64`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
...
// Was: Implementiert das zugehörige Verhalten für `core::fmt::Display for CallTimeout`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
