...
#[derive(Debug)]
// Was: Bündelt die zusammengehörigen Werte für uattach detach Gruppe identity acknowledgement in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `UAttachDetachGroupIdentityAcknowledgement`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for UAttachDetachGroupIdentityAcknowledgement`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
