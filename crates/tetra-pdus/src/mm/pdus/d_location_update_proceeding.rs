...
// Was: Bündelt die zusammengehörigen Werte für dlocation update proceeding in einem Datentyp.
...
// Was: Implementiert das zugehörige Verhalten für `DLocationUpdateProceeding`.
...
// Was: Implementiert das zugehörige Verhalten für `fmt::Display for DLocationUpdateProceeding`.
// Warum: Die Operationen bleiben dadurch direkt bei dem Datentyp, dessen Zustand sie lesen oder verändern.
