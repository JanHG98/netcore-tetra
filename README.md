...
Die GPS-basierte Warnzentrale für NINA/KATWARN und eigene Kartenwarnungen liegt in `system-backend/alert-service`. Die [Installations- und Updateanleitung für den neuen LXC, alle bestehenden LXCs und TBS](Docs/KATWARN_NINA_INSTALL_UPDATE.md) beschreibt Einrichtung, Einmalzustellung, Tests und Rücknahme.
